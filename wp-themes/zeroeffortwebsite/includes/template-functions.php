...
function theme_scripts_styles()
{
	...
	wp_enqueue_script('calendly-widget', '//assets.calendly.com/assets/external/widget.js', ['jquery'], '1.0', true);
...
{
	$logoUrl = get_field('header_logo_desktop', 'options');
...
/*******************************
 Get Inline Svg Code From SVG Url
 *******************************/
